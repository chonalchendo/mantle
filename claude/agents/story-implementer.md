...
1. **Read CLAUDE.md** in the project root to learn coding standards, test conventions, and project structure — including the test command.
...
4. **Write tests** as specified in the ## Tests section. Run the project's test command (from CLAUDE.md) to verify they pass.
...
6. **Run full suite** — run the test command one final time to confirm nothing is broken.

## Rules

- Follow the project's CLAUDE.md exactly — it defines coding standards, conventions, and tooling.
